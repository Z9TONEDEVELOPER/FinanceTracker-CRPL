...
public class JsonStorage : IStorage
{
    ...
    public  async Task SaveTransactions(IReadOnlyList<Transaction> transactions)
    {
    ...
    public  async Task SaveBudgets(Dictionary<CategoryType, Budget> budgets)
    {
    ...
    public  async Task<Dictionary<CategoryType, Budget>> LoadBudgets()
    {
